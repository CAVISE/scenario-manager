    ...
    <Stack spacing={2}>
      <Stack direction="row" spacing={2}>
        <TextField
          ...
          onChange={(e) =>
            updateSimConfigOmnet({ tx_power: parseNumberInputChange(e.target) })
          }
        />
        <TextField
          label="Bitrate (Mbps)"
          ...
          onChange={(e) =>
            updateSimConfigOmnet({ bitrate: parseNumberInputChange(e.target) })
          }
        />
      </Stack>
      <Stack direction="row" spacing={2}>
        <TextField
          ...
          onChange={(e) =>
            updateSimConfigOmnet({
              beaconing_interval: parseNumberInputChange(e.target),
            })
          }
        />
        <TextField
          ...
          onChange={(e) =>
            updateSimConfigOmnet({
              max_interf_dist: parseNumberInputChange(e.target),
            })
          }
        />
      </Stack>
