var libOpenDrive = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    var wasmImports = {
      ...
      E: ___syscall_openat,
      z: __abort_js,
      l: __embind_finalize_value_array,
    ...
    var ___wasm_call_ctors = wasmExports['K'];
    var ___getTypeName = wasmExports['L'];
    var _malloc = wasmExports['N'];
    var _free = wasmExports['O'];
    var __emscripten_stack_restore = wasmExports['P'];
    var __emscripten_stack_alloc = wasmExports['Q'];
    var _emscripten_stack_get_current = wasmExports['R'];
