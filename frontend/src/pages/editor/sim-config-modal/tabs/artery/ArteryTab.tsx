    ...
    <Stack spacing={2}>
        ...
        <TextField
          ...
          onChange={(e) =>
            updateSimConfigArtery({
              sumo_step_length: parseNumberInputChange(e.target),
            })
          }
        />
        <TextField
          ...
          onChange={(e) =>
            updateSimConfigArtery({
              sumo_seed: parseNumberInputChange(e.target),
            })
          }
        />
      </Stack>
      ...
      <Stack direction="row" spacing={2}>
        <TextField
          ...
          onChange={(e) =>
            updateSimConfigArtery({
              middleware_update_interval: parseNumberInputChange(e.target),
            })
          }
        />
        <TextField
      ...
      <Stack direction="row" spacing={2}>
        <TextField
          ...
          onChange={(e) =>
            updateSimConfigArtery({
              cam_interval_min: parseNumberInputChange(e.target),
            })
          }
        />
        <TextField
          ...
          onChange={(e) =>
            updateSimConfigArtery({
              cam_interval_max: parseNumberInputChange(e.target),
            })
          }
        />
      </Stack>
