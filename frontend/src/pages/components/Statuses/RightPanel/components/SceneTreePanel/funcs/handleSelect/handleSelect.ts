...
import { findObjectInScene } from "../sceneUtils/sceneUtils";
import { useEditorStore } from "../../../../../../../../store/useEditorStore";
import { handleSelectProps } from './types/handleSelectTypes';

export function handleSelect({sceneRef,transformControlsRef, onDetach, itemId, pointsArrRef, selectObject, onSelectObject, carMeshesRef}: handleSelectProps){
