...
import { generatePolyXml, generateRouXml, generateSumoCfg } from "../../../../../Generators/exporters";
...
export default function SumoExportSection({openExportDialog}: SimulatorProps) {
  const handleExportSumoCfg = () => {
      const simConfig = mergeSimConfigWithDefaults(useEditorStore.getState().simConfig);
