  ...
  return (
    <Stack spacing={2}>
      ...
      <TextField
        ...
        onChange={(e) =>
          updateSimConfigCAPI({ cmdenv_output_file: e.target.value })
        }
      />
      ...
      <Stack direction="row" spacing={2}>
        ...
        <TextField
          ...
          onChange={(e) =>
            updateSimConfigCAPI({ client_id: Number(e.target.value) })
          }
        />
      </Stack>
      ...
      <Stack direction="row" spacing={2}>
        <TextField
          ...
          onChange={(e) =>
            updateSimConfigCAPI({ traci_hostname: e.target.value })
          }
        />
        <TextField
          label="Port"
          ...
          onChange={(e) =>
            updateSimConfigCAPI({ traci_port: Number(e.target.value) })
          }
        />
      </Stack>
      ...
      <Stack direction="row" spacing={2}>
        <TextField
          ...
          onChange={(e) =>
            updateSimConfigCAPI({ carrier_frequency: e.target.value })
          }
        />
        <TextField
          label="TX power"
      ...
      <TextField
        ...
        onChange={(e) =>
          updateSimConfigCAPI({ channel_number: Number(e.target.value) })
        }
        sx={{ width: '48%' }}
      />
        ...
        <Stack spacing={1}>
          ...
          {capi.ca_service_enabled && (
            <TextField
              ...
              onChange={(e) =>
                updateSimConfigCAPI({ ca_service_port: Number(e.target.value) })
              }
            />
          )}
        </Stack>
          ...
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={(e) =>
                  updateSimConfigCAPI({
                    cosim_service_enabled: e.target.checked,
                  })
                }
              />
            }
          ...
          {capi.cosim_service_enabled && (
            <Stack direction="row" spacing={1}>
              <TextField
                ...
                onChange={(e) =>
                  updateSimConfigCAPI({
                    cosim_service_port: Number(e.target.value),
                  })
                }
              />
              <TextField
                ...
                onChange={(e) =>
                  updateSimConfigCAPI({ cosim_filter_pattern: e.target.value })
                }
              />
            </Stack>
          )}
                ...
                control={
                  <Switch
                    ...
                    onChange={(e) => {
                      ...
                      extra_configs[i] = {
                        ...ec,
                        small_scale_variations: e.target.checked,
                      };
                      updateSimConfigCAPI({ extra_configs });
                    }}
                  />
                ...
                control={
                  <Switch
                    ...
                    onChange={(e) => {
                      ...
                      extra_configs[i] = {
                        ...ec,
                        visualization: e.target.checked,
                      };
                      updateSimConfigCAPI({ extra_configs });
                    }}
                  />
