...
import {
  ...
  PedestrianPath,
  RSUPath,
} from '../ScenarioControlWidget.types';
import type { ScenarioGroup } from '../ScenarioControlWidget.types';
import type { ScenarioGroup as ApiScenarioGroup } from '../../../../../api/scenario.types';
...
import { StartSimulationPayload } from '../../../hooks/useSimulationMutation.types';
